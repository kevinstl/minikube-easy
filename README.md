...
"your-nexus-password" is provided so that you may push artifacts to nexus
 ...
 "location-of-credentials-xml" is the credentials.xml file with path that provides required credentials to jenkins. You can use this [scripts/templates/credentials.xml]([https://github.com/kevinstl/minikube-easy/blob/master/scripts/templates/credentials.xml]) for an example.
