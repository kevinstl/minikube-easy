...
curl -H "Content-Type: text/xml" -XPOST http://minikube-easy:30010/createItem?name="$projectNameSeedPrefix"jenkins-pipeline-k8s-seed --data-binary "@./config-jenkins-pipeline-k8s-seed-fixed.xml"
